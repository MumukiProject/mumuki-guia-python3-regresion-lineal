En este ejemplo, las columnas `period` y `messages_count` no son obedecen a una forma normal, por lo que usaremos el coeficiente de correlación de Spearman para evaluar su correlación. 
